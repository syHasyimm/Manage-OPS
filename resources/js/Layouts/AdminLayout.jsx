...
export default function AdminLayout({ header, children }) {
    ...
    const items = [
        ...
        { href: route('admin.users.index'), name: 'admin.users.*', icon: Users, label: 'Pengguna', mobileLabel: 'Pengguna' },
    ];
    ...
    const totalCols = items.length + 1; // + tab Akun
                ...
                <div className="fixed inset-0 z-40 lg:hidden" role="dialog" aria-modal="true">
                    ...
                    <div className="fixed inset-x-0 bottom-0 rounded-t-2xl bg-white pb-[env(safe-area-inset-bottom)] shadow-2xl">
                        ...
                        <div className="border-t border-navy-100 px-3 py-2">
                            <Link
                                href={route('admin.school-settings.edit')}
                                onClick={() => setAccountOpen(false)}
