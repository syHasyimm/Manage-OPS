...
export default function Edit({ document, categories, statuses }) {
    const fileInputRef = useRef(null);
    // Since we handle file uploads, we use POST with _method=PUT natively via Inertia
    ...
    const submit = (e) => {
        ...
        post(route('admin.documents.update', { document: document.id }), {
            forceFormData: true,
            preserveScroll: true,
            onError: () => toast.error('Gagal memperbarui dokumen. Silakan periksa isian form.'),
        });
    };
            ...
            header={
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <h1 className="mt-1 text-xl font-semibold text-navy-950">Edit Metadata Dokumen</h1>
                    </div>
            ...
            <div className="mx-auto max-w-3xl">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Perbarui informasi metadata dokumen. File asli: <strong>{document.file_name}</strong>
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2 md:col-span-2">
                                    <Label htmlFor="file" className={errors.file ? 'text-red-600' : ''}>
                                        Ganti File Dokumen <span className="text-navy-400 font-normal text-xs">(Opsional)</span>
                                    </Label>
                                    <div className="rounded-lg border border-dashed border-navy-200 bg-navy-50/50 p-5">
                                        ...
                                        <p className="mt-2 text-xs text-navy-500">
                                            Biarkan kosong jika tidak ingin mengganti file. Format didukung: PDF, DOCX, XLSX, PPTX, JPG, PNG. Maksimal 10 MB.
                                        </p>
                                    </div>
